    ...
    module CDoc
      ...
      class Comment
        ...
        class << self
          ...
          # lines as the comment target.  Takes a string or a StringScanner
          ...
          #   # [''],
          #   # []]
          #   c.target_line   # => "this is the target line"
          #
          def parse(str) # :yields: fragment
            scanner = case str
            ...
            unless broke_on_comment
              scanner.skip(/\s+/)
              unless scanner.peek(1) == '#'
                comment.target_line = scanner.scan(/.+?$/) 
                comment.target_line.strip! unless comment.target_line == nil
              end
            end
