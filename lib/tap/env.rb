  ...
  class Env
    ...
    class << self
      ...
      def inherited(base)
        base.instance = nil
        base.instances = {}
        base.manifests = DEFAULT_MANIFESTS.dup
        super unless base == Tap::Env
      end
    ...
    # The default manifests for Env
    DEFAULT_MANIFESTS = {:envs => Manifest}
    ...
    def deactivate
      ...
      @active = false
      @manifests.clear
      self.class.instance = nil if self.class.instance == self
