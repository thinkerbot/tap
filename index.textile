...
A framework for creating configurable, distributable tasks and workflows. Kind of like "Rake":http://rake.rubyforge.org/, kind of like "Rails":http://www.rubyonrails.org/, but geared towards command line applications.
...
See the "Tutorial":{{ site.home }}/tap-suite/files/doc/Tutorial.html and "Documentation":{{ site.home }}/rdoc/index.html for more information.
