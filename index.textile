...
All that said, "Tap":{{ site.links.tap }} is often used as a really advanced "Rake":{{ site.links.rake }} for providing toolkits to developers.  
...
p. See the "Tutorial":{{ site.links.tutorial }} and "Documentation":{{ site.links.rdoc }} for more information.
