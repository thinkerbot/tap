...
class NodeTest < Test::Unit::TestCase
  ...
  def test_if_resetting_output_produces_an_orphan_join_then_set_output_sets_children_to_natural_round
    join1 = [[], []]
    join2 = [[], []]
