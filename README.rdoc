...
Tap is setup for easy development. Clone the repo and then run the tests; all
dependencies will be setup for you. Bundler[http://gembundler.com/] is
required.
...
Afterwards you can develop Tap using tap. Specify one or more modules to test,
or specify none to test them all. See the tapfile for the actual tasks being
run.

  % ./tapexe test [tap,tap-test,...]
